from Base import *
from Classes.ClassSubtitleMovie import *
from Classes.ClassSubtitleTvSeries import *
    ...
    class Runnable(BaseRunnable):
        def run(self):
            ...
            for index in range(len(self.list)):
                ...
                Print.print_white("Folder ---> " + str(t))

                if os.path.isdir(file):
                    if FILM_TYPE_FINAL == 1:
                        ClassSubtitleMovie(t, h + t, "farsi/persian")

                    elif FILM_TYPE_FINAL == 2:
                        ClassSubtitleTvSeries(t, h + t, "farsi/persian")

                Print.print_full_line()

            Print.print_cyan("Finished !!!")
